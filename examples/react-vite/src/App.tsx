...
function App() {
  ...
  return (
    <div className="w-screen mx-auto p-4 dark:bg-gray-900">
      <h1 className="text-3xl text-center font-bold mb-4">Rich Editor Test</h1>
      <button
        className="bg-gray-800 mb-4 cursor-pointer hover:bg-gray-900 transition-colors duration-200 text-white px-4 py-2 rounded-md mx-auto block"
      ...
      {/* Basic usage */}
      {!showContent && <div className="mb-8 mx-auto max-w-2/3">
        <RichEditor
          className=""
          toolbarClassName="bg-[#292a2c]"
          content={content}
          onUpdate={(editor) => {
      ...
      {showContent && (
        <div className="mt-4 rounded-md border mx-auto max-w-2/3 overflow-x-auto h-[500px]">
          <RichEditor
            className=""            
            content={content}
            showToolbar={false}
